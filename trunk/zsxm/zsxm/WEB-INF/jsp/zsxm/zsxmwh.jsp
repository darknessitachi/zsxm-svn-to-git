...
.fsg_nr{ position:absolute; display:none;top:25px; right:-3px; background:#fff; border:1px solid #98B1C8; }			
	...
	<body style="margin: 0px; overflow: hidden; margin: 2px;">
		<s:form name="spForm" action="zsxmwh!getList.do" method="post">
	...
	var gridOption = {
		...
		remoteSort : true,
		remoteFilter : true,
		loadURL : APP_PATH + '/zsxmwh!getList.do',
		exportURL : APP_PATH + '/zsxmwh!exportList.do',
		exportFileName : "项目信息",
		autoLoad : true
	};
	...
	function reprow(){
		...
		if(len==1){
			 ...
			 openWin("zsxm!preZsxmU.do?xmid="+mygrid.getSelectedRecord().XMID+"&opttype=3",w,h);
		}
	}
	...
	function deldata(){
		...
		if(window.confirm("请确定需要删除《"+len+"》条记录!")){
			var ajax = new AppAjax("zsxmwh!deletezsxm.do?xmid="+r,save_Back).submit();
		}
	}
