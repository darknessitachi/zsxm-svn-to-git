...
<html>
	...
	<body >
		<s:component template="xtitle" theme="app" value='项目标引维护'></s:component>
	    ...
	    <div id="xwincontent">
	    	<table cellspacing="0" class="fxtable"  style="margin-bottom:10px;">
	        	<tr>
	        		<td style="text-align:center;background:#E7F2FC;font:bold 12px 'lucida Grande',Verdana;width:40%;">项目标引名称</td>
	...
	<script type="text/javascript">
		function doSave(){
			if($('option').value == 1){
				var ajax = new AppAjax("zsxmby!addBywh.do",save_Back).submitForm("czrcForm");
			}else{
				var ajax = new AppAjax("zsxmby!repXmby.do",save_Back).submitForm("czrcForm");
			}
		}
