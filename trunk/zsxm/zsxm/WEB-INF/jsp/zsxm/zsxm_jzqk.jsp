...
<html>
	...
	<body>
	<s:form name="czrcForm" action='zsxm!preJzqk.do' method="post" >
	<s:hidden name="xmid"></s:hidden>
	<s:hidden name="pname"></s:hidden>
	<s:hidden name="opttype"></s:hidden>
 <!--个人信息 start-->
	<div class="title"  onclick=""><h2>进展情况 &nbsp&nbsp&nbsp&nbsp&nbsp
	...
	<script type="text/javascript">
		...
		function addxx(){
			parent.openWin("zsxm!preJzqkI.do?xmid="+$('xmid').value+"&opttype=1&pname="+$('pname').value,"500","240");
		}
		...
		function repxx(){
			...
			parent.openWin("zsxm!preJzqkU.do?xmid="+$('xmid').value+"&xh="+rcsel[0].v+"&opttype=3&pname="+$('pname').value,"500","240");
		}
		...
		function delxx(){
			...
			if(window.confirm("您确定要删除 "+rcsel.length+" 条信息?")){
				var ajax = new AppAjax("zsxm!doJzqkD.do",sava_back).submitForm("czrcForm");
			}
		}
