...
<ul class="nav">
	...
	<li class="" id="rcdali7"><a href="javascript:" id="rcda7" onclick="activeChange('rcdali7');">承担横向项目情况</a></li>
	 -->
	<li class="on" id="rcdali8"><a href="javascript:" id="rcda8" onclick="activeChange('rcdali8');">机构人员情况</a></li>
	<li class="" id="rcdali10"><a id="rcda10"href="javascript:">-------</a></li>
	<li class="" id="rcdali9"><a href="javascript:" id="rcda9" >-------</a></li>
	
	<li id="rcdali1"><a href="javascript:" id="rcda1">-------</a>
</ul>
...
<script type="text/javascript">
		...
		$('rcda_dis').src = 'zsdw!preRyxx.do?dwid=<s:property value="dwid"/>&opttype=<s:property value="opttype"/>&pname='+self.name;
		var reload = 0;
