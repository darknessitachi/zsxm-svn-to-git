 ...
 <div style="width:100%">
    	...
    	<table class="fxtable"  cellpadding="0">
			...
			<tr>
				<td colspan=2>
					...
					<tr>
						<td align=center><s:textfield name="jfh.shzzbz" cssStyle="width:80" onfocus="javascript:this.select();" onblur="javascript:RC.isNum(this.id);"></s:textfield>&nbsp
						</td>
				...
				<table>
					...
					<input type="checkbox" name="jfh.zfzfd2" value="1" <s:if test="jfh.zfzfd2==1">checked</s:if>/>城外
						...
						<td align=center>
							<s:textfield name="jfh.zfbtbz" cssStyle="width:80" onfocus="javascript:this.select();" onblur="javascript:RC.isNum(this.id);"></s:textfield>
							<br>
							<s:textfield name="jfh.zfbtbz2" cssStyle="width:80" onfocus="javascript:this.select();" onblur="javascript:RC.isNum(this.id);"></s:textfield>
						</td>
	...
	<script type="text/javascript">
		...
		function doSave(type){
			...
			var ajax = new AppAjax("jfhsb!doDataSh1.do?opttype="+type,function(data){save_Back(data,type)}).submitForm("zsdwForm");
		}
