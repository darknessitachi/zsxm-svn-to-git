...
<html>
	...
	<body>
	<s:form name="czrcForm" action='zsdw!preYqfw.do' method="post" >
	<s:hidden name="dwid"></s:hidden>
	<s:hidden name="pname"></s:hidden>
	<s:hidden name="opttype"></s:hidden>
 <!--个人信息 start-->
	<div class="title"  onclick=""><h2>园区服务 &nbsp&nbsp&nbsp&nbsp&nbsp
	...
	<script type="text/javascript">
		...
		function addxx(){
			parent.openWin("zsdw!preYqfwI.do?dwid="+$('dwid').value+"&opttype=1&pname="+$('pname').value,"500","240");
		}
		...
		function repxx(){
			...
			parent.openWin("zsdw!preYqfwU.do?dwid="+$('dwid').value+"&xh="+rcsel[0].v+"&opttype=3&pname="+$('pname').value,"500","240");
		}
		...
		function delxx(){
			...
			if(window.confirm("您确定要删除 "+rcsel.length+" 条信息?")){
				var ajax = new AppAjax("zsdw!doYqfwD.do",sava_back).submitForm("czrcForm");
			}
		}
