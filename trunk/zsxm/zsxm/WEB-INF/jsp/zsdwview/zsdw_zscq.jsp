...
<html>
	...
	<body>
	<s:form name="czrcForm" action='zsdw!preZscq.do' method="post" >
	<s:hidden name="dwid"></s:hidden>
	<s:hidden name="pname"></s:hidden>
	<s:hidden name="opttype"></s:hidden>
 <!--个人信息 start-->
	<div class="title"  onclick=""><h2> 拥有知识产权情况 &nbsp&nbsp&nbsp&nbsp&nbsp
	...
	<div class="footer">
		<input class="btn_submit1" type="button" value="下 一 步" onclick="javascript:parent.activeChange('rcdali7');"/>
		<s:if test="opttype==3">
	...
	<script type="text/javascript">
		...
		function addxx(){
			parent.openWin("zsdw!preZscqI.do?dwid="+$('dwid').value+"&opttype=1&pname="+$('pname').value,"400","270");
		}
		...
		function repxx(){
			...
			parent.openWin("zsdw!preZscqU.do?dwid="+$('dwid').value+"&xh="+rcsel[0].v+"&opttype=3&pname="+$('pname').value,"400","270");
		}
		...
		function delxx(){
			...
			if(window.confirm("您确定要删除 "+rcsel.length+" 条信息?")){
				var ajax = new AppAjax("zsdw!doZscqD.do",sava_back).submitForm("czrcForm");
			}
		}
