...
<script type="text/javascript" src="<c:url value="/js/rc_init_v.js"/>" ></script>
...
<script type="text/javascript">
		$('rcda_dis').src = 'zsdwview!preZsdw.do?dwid=<s:property value="dwid"/>&opttype=<s:property value="opttype"/>&pname='+self.name;
		var reload = 0;
