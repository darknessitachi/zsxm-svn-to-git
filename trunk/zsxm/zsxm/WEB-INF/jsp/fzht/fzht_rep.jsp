...
<body >
<s:component template="xtitle" theme="app" value='房租合同信息修改'></s:component>
...
<script type="text/javascript">
		$('rcda_dis').src = 'fzht!preFzht.do?htid=<s:property value="htid"/>&opttype=<s:property value="opttype"/>&pname='+self.name;
		var reload = 0;
