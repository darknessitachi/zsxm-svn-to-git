...
<html>
	...
	var gridOption_dep = {
		id : 'grid_dep',
		loadURL : APP_PATH + '/fzhtanalys!queryListByType.do',
		exportURL : APP_PATH + '/fzhtanalys!doExportList.do',
