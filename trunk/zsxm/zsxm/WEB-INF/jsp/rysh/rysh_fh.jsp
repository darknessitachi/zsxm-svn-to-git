...
<html>
	...
	<body>
	<s:component template="xtitle" theme="app" value='数据发回原因'></s:component>
 ...
 <!--个人信息 start-->
	...
	<script type="text/javascript">
		...
		function doSave(type){
			...
			var ajax = new AppAjax("rysh!doShfh.do",function(data){save_Back(data,type)}).submitForm("czrcForm");
		}
