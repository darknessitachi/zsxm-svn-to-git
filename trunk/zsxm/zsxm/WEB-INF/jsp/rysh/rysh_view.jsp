...
<html>
	...
	<body>
	<s:component template="xtitle" theme="app" value='人员信息预览'></s:component>
	...
	<div class="xwincontent" id="xwincontent" style="overflow:auto">
		...
		<table align="center" cellpadding="0" cellspacing="0" id="tab2" >
			...
			<tr>
				<td>金凤凰上报选择：</td>
				<td colspan=7>
					<input type="checkbox" value='1' name="jfhsbtype"/>生活资助&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value='2' name="jfhsbtype"/>住房补助&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value='3' name="jfhsbtype"/>安家费&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
