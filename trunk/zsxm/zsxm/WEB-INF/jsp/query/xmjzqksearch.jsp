	...
	<div id="tableContainer" style="height:90%;overflow:auto">
				<table class="fxtable"  cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="left" colspan=3>
							<input type="text" class="Wdate" name="jzrq1" id="jzrq1" style="text-align:left;width:130" value="" onfocus="new WdatePicker(this,'%Y-%M-%D')" MINDATE="1960-01-01" readonly/>
							-
							<input type="text" class="Wdate" name="jzrq2" id="jzrq2" style="text-align:left;width:130" value="" onfocus="new WdatePicker(this,'%Y-%M-%D')" MINDATE="1960-01-01" readonly/>
						</td>
...
<script type="text/javascript" src="<c:url value="/js/rc_init.js"/>" ></script>	
	<script type="text/javascript">
		...
		function doTrue(){
			...
			if($('jzrq1').value != '' ){
				RH += " and jzrq >='"+$('rq1').value+"'";
			}
			if($('jzrq2').value != '' ){
				RH += " and jzrq <='"+$('rq2').value+"'";
			}
