...
<html>
	...
	var gridOption_dep = {
		id : 'grid_dep',
		loadURL : APP_PATH + '/analys!queryListByType.do',
	...
	var colsOption_std =[{
		...
		width : 60,
		renderer : function(v){
			return '<a target="_blank" href="rcdaxxwh!preView.do?rcid='+v+'">详情</a>';
		}
	} ];
	var gridOption_std = {
	    skin : "vista",
