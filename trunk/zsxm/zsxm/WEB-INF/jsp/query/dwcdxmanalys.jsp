...
<html>
				...
				<tr>
				    ...
				    <td class="center" >
				    	统计内容 <select name="cxtype" style="width: 150px">
				    	   <option value="1">立项级别</option>
				    	   <option value="2">计划类别</option>
				    	 </select>
	...
	var gridOption_dep = {
		id : 'grid_dep',
		loadURL : APP_PATH + '/dwcdxmanalys!queryListByType.do',
		exportURL : APP_PATH + '/dwcdxmanalys!doExportList.do',
...
var colsOption_std = [ 
	...
	var gridOption_std = {
		...
		remoteSort : true,
		remoteFilter : false,
		loadURL : APP_PATH + '/dwquery!getListCdxm.do',
		exportURL : APP_PATH + '/dwquery!exportListCdxm.do',
		exportFileName : "列表",
		autoLoad : false,
