...
<html>
	...
	<body style="margin: 0px; margin: 2px;">
		<table width="100%" cellpadding="0" cellspacing="0" id="conTable" >
				...
				<tr>
				    ...
				    <td class="center" >
				    	统计内容 
				    	<select name="cxtype" style="width: 150px">
				    	   <option value="1">项目类别</option>
				    	   <option value="2">星级</option>
				    	   <option value="3">项目进度概述</option>
	...
	var gridOption_dep = {
		id : 'grid_dep',
		loadURL : APP_PATH + '/xmanalys!queryListByType.do',
		exportURL : APP_PATH + '/xmanalys!doExportList.do',
