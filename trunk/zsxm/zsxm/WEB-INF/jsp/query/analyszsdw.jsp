				...
				<tr>
				    ...
				    <td class="center" >
				    	统计内容 <select name="cxtype" style="width: 150px">
				    	   ...
				    	   <option value="5">国家创新型科技园区（常州市）</option>
				    	    <option value="10">高新技术企业</option>
				    	   <option value="11">软件企业</option>
				    	   <option value="12">动漫企业</option>
				    	   <option value="13">CMMI认证</option>
				    	   <option value="14">商标</option>
				    	   <option value="15">国家七大新兴产业(十二五期间)</option>
				    	   <option value="16">现代服务业</option>
				    	   <option value="17">服务外包</option>
				    	   <option value="18">两化融合</option>
				    	   <option value="A1">注册资本（开办经费）</option>
				    	   <option value="A2">销售收入</option>
				    	   <option value="A3">销售收入增长率</option>
				    	   <option value="A4">税收情况</option>
				    	   <option value="A5">税收增长率</option>
				    	   <option value="A6">员工情况</option>
				    	   <option value="A7">员工增长率</option>
				    	 </select>
...
var colsOption_std = [ 
	<s:iterator id="col" value="gcols">
	 ...
	 colsOption_std.splice(colsOption_std.length-1,1);
	var gridOption_std = {
	    skin : "vista",
		id : 'grid_std',
		width : "100%",
