...
<script type="text/javascript" src="<c:url value="/js/xm_init_v.js"/>" ></script>
...
<script type="text/javascript">
		$('rcda_dis').src = 'zsxmview!preZsxm.do?xmid=<s:property value="xmid"/>&opttype=<s:property value="opttype"/>&pname='+self.name;
		var reload = 0;
