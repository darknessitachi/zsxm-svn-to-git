...
<html>
	...
	<s:form name="czrcForm" id="form1" action="zsxmby!getZsxmWaitSelect.do" method="post">
		...
		<div id="rcflmx"  class="tableContainer" style="width:100%">
			...
			<tr>
				<td><input type="checkbox" name="xmid" value='<s:property value="xmid"/>'></td>
...
<script type="text/javascript">
	...
	function doSave(){
		var ajax = new AppAjax("zsxmby!doSelectZsxmmx.do",save_Back).submitForm("czrcForm");
	}
