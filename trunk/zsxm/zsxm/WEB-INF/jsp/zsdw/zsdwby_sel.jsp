...
<html>
	...
	<s:form name="czrcForm" id="form1" action="zsdwby!getZsDwWaitSelect.do" method="post">
		...
		<div class="butbar" id="butbar" style="height:60px">
			<div class="left">		 	
				字段1：
				...
				<br>
				字段2：
				<s:select name="query.field2" list="fields" cssStyle="width:130" listKey="dm" listValue="mc"  headerKey="" headerValue="--请选择--" />
				=
				<s:textfield name="query.value2"></s:textfield>
...
<script type="text/javascript">
	$('rcflmx').style.height= getSize().h-110;
