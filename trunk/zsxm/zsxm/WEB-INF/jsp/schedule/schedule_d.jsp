...
<html>
	...
	<script type="text/javascript">
		...
		function doSave(type){
			...
			if(type ==1){
				var ajax = new AppAjax("schedule!doScheduleI.do",function(data){save_Back(data,type)}).submitForm("czrcForm");
			}else if(type == 2){
				var ajax = new AppAjax("schedule!doScheduleI.do",function(data){save_Back(data,type)}).submitForm("czrcForm");
			}else if(type == 3){
				var ajax = new AppAjax("schedule!doScheduleU.do",function(data){save_Back(data,type)}).submitForm("czrcForm");
			}
		}
