...
.fsg_nr{ position:absolute; display:none;top:25px; right:-3px; background:#fff; border:1px solid #98B1C8; }			
	...
	var gridOption = {
		...
		remoteSort : true,
		remoteFilter : true,
		loadURL : APP_PATH + '/jfhwh!getAjfList.do?treekey='+$F('treekey'),
		exportURL : APP_PATH + '/jfhwh!exportAjfList.do?treekey='+$F('treekey'),
	...
	function xgJfh(){
		...
		parent.openWin("jfhwh!preDataxg2.do?sbid="+mygrid.getSelectedRecord().SBID+"&dwid="+mygrid.getSelectedRecord().DWID+"&ryid="+mygrid.getSelectedRecord().RYID+"&treekey="+$F('treekey'),w,h);
	}
	...
	function loadTree(){
		if($("xtdlb").loading != 1){
			...
			tree.loadJSON("jfhwh!getAjfDwTree.do",function(){$('xtdlbloadimage').style.display="none";});
			$('xtdlb').loading = 1;			
		}
	}
	function setV(id){
