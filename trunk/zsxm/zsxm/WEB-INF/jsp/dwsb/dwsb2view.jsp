 ...
 <div style="width:100%">
	...
	<div class="tableContainer" id="tableContainer" style="height:90%">
    	<table class="fxtable"  cellpadding="0">
    		...
    		<tr>
    			<td style="text-align:right;background:#E7F2FC;font:bold 12px 'lucida Grande',Verdana;width:20%">专业技术人员数</td>
				<td colspan=3>
			...
			<tr>
				<td style="text-align:right;background:#E7F2FC;font:bold 12px 'lucida Grande',Verdana;width:20%;border-bottom: 2px solid #778899;">其中：研究与试验发展支出</td>
				<td style="border-bottom: 2px solid #778899;">
				...
				<td style="text-align:right;background:#E7F2FC;font:bold 12px 'lucida Grande',Verdana;width:20%;border-bottom: 2px solid #778899;">其中：新产品开发经费支出</td>
				<td style="border-bottom: 2px solid #778899;">
	...
	<script type="text/javascript">
		//$('tableContainer').style.height=getSize().h-130; 
		if(getSize().w > 960){
