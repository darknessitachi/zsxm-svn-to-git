...
<html>
	...
	<s:form name="czrcForm" id="form1" action="dwsb!getDwsbWaitSelect.do" method="post">
		<s:component template="xtitle" theme="app" value='选择企业'></s:component>
		<s:hidden name="dm"></s:hidden>
		<s:hidden name="dmlx" id="dmlx"></s:hidden>
		...
		<div id="rcflmx"  class="tableContainer" style="width:100%">
			...
			<thead>
			<tr><td style="width:10px;"><input type="checkbox" id="alluser"  onclick="RC.checkboxAll('dwid',this.checked)"/></td>
			<td>组织机构代码</td>
			<td>单位名称</td>
			<td>单位状态</td>
			<td>单位类型</td>
...
<script type="text/javascript">
	...
	function doSave(){
		var ajax = new AppAjax("dwsb!doSelectDwsbmx.do",save_Back).submitForm("czrcForm");
	}
