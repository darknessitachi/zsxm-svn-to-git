	...
	<div class="tableContainer" id="tableContainer" style="height:90%">
    	<table class="fxtable"  cellpadding="0">
    		...
    		<tr>
				...
				<td colspan=4>
					<s:textfield name="dwsb.gjzcs" id="TDF8H316"  value="%{dwsb.gjzcs==''?'0':dwsb.gjzcs}" cssStyle="width:100px"  onfocus="javascript:this.select();" onblur="javascript:RC.isNumInt(this.id);"></s:textfield>
				</td>
    		</tr>
    		<tr>
				...
				<td>
					<s:textfield name="dwsb.hgjwjzjrs" id="TDF8H317"  value="%{dwsb.hgjwjzjrs==''?'0':dwsb.hgjwjzjrs}" cssStyle="width:100px"  onfocus="javascript:this.select();" onblur="javascript:RC.isNumInt(this.id);"></s:textfield>
				</td>
				...
				<td>
					<s:textfield name="dwsb.gjzchbsrs" id="TDF8H318"  value="%{dwsb.gjzchbsrs==''?'0':dwsb.gjzchbsrs}" cssStyle="width:100px"  onfocus="javascript:this.select();" onblur="javascript:RC.isNumInt(this.id);"></s:textfield>
				</td>
    		</tr>
