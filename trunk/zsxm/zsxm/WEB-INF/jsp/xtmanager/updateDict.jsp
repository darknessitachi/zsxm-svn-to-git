...
<html>
	...
	<body >
		...
		<s:component template="xtitle" theme="app" value='修改字典'></s:component>
	    <div id="xwincontent">
	    	...
	    	<div class="title">
		    	<span style='margin-left:0px;float:left'>
		    			&nbsp;&nbsp;&nbsp;排序号：&nbsp;&nbsp;
		    			<input type="text" id="dictname" name="query.sort" value="${listMap.SORT}">
	          	</span>
	    	</div>
	   ...
	   <div class="footer">
        	<input type="button" class="btn" value="保存" onclick="updatedict()"/>
	...
	<script type="text/javascript">
		function updatedict(){
			...
			var ajax = new AppAjax("xtmanager!updteDict.do",save_Back);
			ajax.submitForm("emasForm");
		}
		
	function save_Back(data){
		if(data.message.code >0){
			parent.mainFrameContainer.document.all.codename.value = document.getElementById("dictname").value;
