...
@Controller
@Results( { 
			@Result(name = "input", value = "/WEB-INF/jsp/zsxmview/zsxm.jsp"),
			@Result(name = "rep", value = "/WEB-INF/jsp/zsxmview/zsxm_rep.jsp"),
			@Result(name = "zsxm", value = "/WEB-INF/jsp/zsxmview/zsxm_info.jsp"),
			@Result(name = "jzqk", value = "/WEB-INF/jsp/zsxmview/zsxm_jzqk.jsp"),
			@Result(name = "jzqkd", value = "/WEB-INF/jsp/zsxmview/zsxm_jzqk_d.jsp"),
			@Result(name = "lxr", value = "/WEB-INF/jsp/zsxmview/zsxm_dflxr.jsp"),
			@Result(name = "lxrd", value = "/WEB-INF/jsp/zsxmview/zsxm_dflxr_d.jsp"),
			@Result(name = "view", value = "/WEB-INF/jsp/zsxmview/zsxm_view.jsp")
			})
public class ZsxmviewAction extends BaseAction{
