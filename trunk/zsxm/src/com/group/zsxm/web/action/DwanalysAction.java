...
@Scope("prototype")
@Controller
@Results( { @Result(name = "input", value = "/WEB-INF/jsp/query/analyszsdw.jsp") })
public class DwanalysAction extends BaseAction{
	@Autowired
	private AnalysService analysService;

	public String execute() {
		gheades = analysService.getGridHeaders("3");
		gcols = analysService.getGridCols("3");
		return Action.INPUT;
	}
	...
	public void doQueryListByType() {
		...
		map.put("type", type);
		List list = analysService.getListForDw(map);
