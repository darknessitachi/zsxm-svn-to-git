...
@Scope("prototype")
@Controller
@Results( { @Result(name = "input", value = "/WEB-INF/jsp/fzht/fzht.jsp"),
			@Result(name = "update", value = "/WEB-INF/jsp/fzht/fzht_rep.jsp"),
			@Result(name = "rep", value = "/WEB-INF/jsp/fzht/fzht_rep.jsp"),
			@Result(name = "ht", value = "/WEB-INF/jsp/fzht/fzht_ht.jsp"),
			@Result(name = "fzsq", value = "/WEB-INF/jsp/fzht/fzht_sq.jsp"),
			@Result(name = "fzsqd", value = "/WEB-INF/jsp/fzht/fzht_sq_d.jsp"),
			
			@Result(name = "selectdw", value = "/WEB-INF/jsp/fzht/fzht_dw_sel.jsp"),
			@Result(name = "view", value = "/WEB-INF/jsp/fzht/fzht_view.jsp")
			})
public class FzhtAction extends BaseAction{
	@Autowired
