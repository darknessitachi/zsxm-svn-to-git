...
@Results( { @Result(name = "xxzgpre", value = "/widgets/xxzgEdit.jsp"),
			@Result(name = "uploadok", value = "/WEB-INF/jsp/xxgl/fileUploadDone.jsp"),
			@Result(name = "zgsp", value = "/WEB-INF/jsp/xxgl/xxsp.jsp"),
			@Result(name = "showXxzg", value = "/WEB-INF/jsp/xxgl/showXxzg.jsp"),
			@Result(name = "xxglpre", value = "/WEB-INF/jsp/xxgl/xxgl.jsp"),
			@Result(name = "lmglpre", value = "/WEB-INF/jsp/xxgl/lmglPre.jsp"),
			@Result(name = "lmgl_detail", value = "/WEB-INF/jsp/xxgl/lmgl_detail.jsp")
...
public class XxglAction extends BaseAction{
	...
	public void doQueryIndex(){
    	Map mapOut = new HashMap();
		mapOut.put("xxzgList",xxglService.getIndexListByLx("1"));
		mapOut.put("xwList",xxglService.getIndexListByLx("5"));
	//	mapOut.put("ggList",xxglService.getIndexListByLx("6"));
		mapOut.put("tzList",xxglService.getIndexListByLx("6"));
		mapOut.put("schedule",xxglService.getIndexListBySchedule(xtuser.getUserid()));
		renderText(JSONObject.fromMap(mapOut).toString());
