...
@Scope("prototype")
@Controller
@Results( { @Result(name = "input", value = "/WEB-INF/jsp/zsdwview/zsdw.jsp"),
	@Result(name = "update", value = "/WEB-INF/jsp/zsdwview/zsdw_rep.jsp"),
	@Result(name = "rep", value = "/WEB-INF/jsp/zsdwview/zsdw_rep.jsp"),
	@Result(name = "dwxx", value = "/WEB-INF/jsp/zsdwview/zsdw_dwxx.jsp"),
	@Result(name = "gqbl", value = "/WEB-INF/jsp/zsdwview/zsdw_gqbl.jsp"),
	@Result(name = "gqbld", value = "/WEB-INF/jsp/zsdwview/zsdw_gqbl_d.jsp"),
	
	@Result(name = "cdxm", value = "/WEB-INF/jsp/zsdwview/zsdw_cdxm.jsp"),
	@Result(name = "cdxmd", value = "/WEB-INF/jsp/zsdwview/zsdw_cdxm_d.jsp"),

	@Result(name = "cdhxxm", value = "/WEB-INF/jsp/zsdwview/zsdw_cdhxxm.jsp"),
	@Result(name = "cdhxxmd", value = "/WEB-INF/jsp/zsdwview/zsdw_cdhxxm_d.jsp"),
	
	@Result(name = "zscq", value = "/WEB-INF/jsp/zsdwview/zsdw_zscq.jsp"),
	@Result(name = "zscqd", value = "/WEB-INF/jsp/zsdwview/zsdw_zscq_d.jsp"),
	
	@Result(name = "hjqk", value = "/WEB-INF/jsp/zsdwview/zsdw_hjqk.jsp"),
	@Result(name = "hjqkd", value = "/WEB-INF/jsp/zsdwview/zsdw_hjqk_d.jsp"),
	
	@Result(name = "lxr", value = "/WEB-INF/jsp/zsdwview/zsdw_lxr.jsp"),
	@Result(name = "lxrd", value = "/WEB-INF/jsp/zsdwview/zsdw_lxr_d.jsp"),
	
	@Result(name = "ryxx", value = "/WEB-INF/jsp/zsdwview/zsdw_ryxx.jsp"),
	@Result(name = "ryxxd", value = "/WEB-INF/jsp/zsdwview/zsdw_ryxx_d.jsp"),
	
	@Result(name = "sysjsqk", value = "/WEB-INF/jsp/zsdwview/zsdw_sysjsqk.jsp"),
	@Result(name = "sysjsqkd", value = "/WEB-INF/jsp/zsdwview/zsdw_sysjsqk_d.jsp"),
	
	@Result(name = "yfjgqk", value = "/WEB-INF/jsp/zsdwview/zsdw_yfjgqk.jsp"),
	@Result(name = "yfjgqkd", value = "/WEB-INF/jsp/zsdwview/zsdw_yfjgqk_d.jsp"),
	
	@Result(name = "lssj", value = "/WEB-INF/jsp/zsdwview/zsdw_lssj.jsp"),
	@Result(name = "lssjd", value = "/WEB-INF/jsp/zsdwview/zsdw_lssj_d.jsp"),
	
	@Result(name = "yqfw", value = "/WEB-INF/jsp/zsdwview/zsdw_yqfw.jsp"),
	@Result(name = "yqfwd", value = "/WEB-INF/jsp/zsdwview/zsdw_yqfw_d.jsp"),
	
	@Result(name = "yqyhtj", value = "/WEB-INF/jsp/zsdwview/zsdw_yqyhtj.jsp"),
	@Result(name = "yqyhtjd", value = "/WEB-INF/jsp/zsdwview/zsdw_yqyhtj_d.jsp"),
	
	@Result(name = "selectxm", value = "/WEB-INF/jsp/zsdwview/zsdw_xm_sel.jsp"),
	@Result(name = "view", value = "/WEB-INF/jsp/zsdwview/zsdw_view.jsp"),
	@Result(name = "treesel", value = "/WEB-INF/jsp/zsdwview/zsdw_tree_sel.jsp"),
	@Result(name = "queryfj", value = "/WEB-INF/jsp/zsdwview/zsdw_ryxx_fj.jsp"),
	@Result(name = "allview", value = "/WEB-INF/jsp/zsdwview/zsdw_view_all.jsp")
})
public class ZsdwviewAction extends BaseAction{
	...
	private List<Map<String, String>> qlist1;
	private List<Map<String, String>> qlist2;
	private List<Map<String, String>> qlist3;
	private List<Map<String, String>> qlist4;
	private List<Map<String, String>> qlist5;
	private List<Map<String, String>> qlist6;
	private List<Map<String, String>> qlist7;
	private List<Map<String, String>> qlist8;
	private List<Map<String, String>> qlist9;
	private List<Map<String, String>> qlist10;
	private List<Map<String, String>> qlist11;
	...
	public String getZsdwAllView(){
		qzzxm = zsdwService.getDwxmByDwid(dwid);
		yjlbs = zsdwService.getZsdwMutSelListByDwid(dwid, "4");
		List<Map<String, String>> hyfls = zsdwService.getZsdwMutSelListByDwid(dwid, "5");
		String hyfl="",hymc="";
		
		zsdw = zsdwService.getZsdwinfoBydwidByv(dwid);
		for(int i=0;i<hyfls.size();i++){
			if(hyfl.equals("")){
				hyfl = hyfls.get(i).get("seldm");
			}else{
		...
		qlist1 = zsdwService.getGqblList(dwid,gqbl_tzze);
		
		qlist2 = zsdwService.getYqyhtjList(dwid);
		
		qlist3 = zsdwService.getRyxxList(dwid);
		
		qlist4 = zsdwService.getZscqList(dwid);
		
		qlist5 = zsdwService.getCdxmList(dwid);
		
		qlist6 = zsdwService.getCdhxxmList(dwid);
		
		qlist7 = zsdwService.getSysjsqkList(dwid);
		
		qlist8 = zsdwService.getYfjgqkList(dwid);
		
		qlist9 = zsdwService.getHjqkList(dwid);
		
		qlist10 = zsdwService.getLssjList(dwid);
		
		qlist11 = zsdwService.getYqfwList(dwid);
		return "allview";
	}
	...
	public List<Map<String, String>> getQlist1() {
		return qlist1;
	}
	public void setQlist1(List<Map<String, String>> qlist1) {
		this.qlist1 = qlist1;
	}
	...
	public List<Map<String, String>> getQlist3() {
		return qlist3;
	}
	public void setQlist3(List<Map<String, String>> qlist3) {
		this.qlist3 = qlist3;
	}
	public List<Map<String, String>> getQlist4() {
		return qlist4;
	}
	public void setQlist4(List<Map<String, String>> qlist4) {
		this.qlist4 = qlist4;
	}
	public List<Map<String, String>> getQlist5() {
		return qlist5;
	}
	public void setQlist5(List<Map<String, String>> qlist5) {
		this.qlist5 = qlist5;
	}
	public List<Map<String, String>> getQlist6() {
		return qlist6;
	}
	public void setQlist6(List<Map<String, String>> qlist6) {
		this.qlist6 = qlist6;
	}
	public List<Map<String, String>> getQlist7() {
		return qlist7;
	}
	public void setQlist7(List<Map<String, String>> qlist7) {
		this.qlist7 = qlist7;
	}
	public List<Map<String, String>> getQlist8() {
		return qlist8;
	}
	public void setQlist8(List<Map<String, String>> qlist8) {
		this.qlist8 = qlist8;
	}
	public List<Map<String, String>> getQlist9() {
		return qlist9;
	}
	public void setQlist9(List<Map<String, String>> qlist9) {
		this.qlist9 = qlist9;
	}
	public List<Map<String, String>> getQlist10() {
		return qlist10;
	}
	public void setQlist10(List<Map<String, String>> qlist10) {
		this.qlist10 = qlist10;
	}
	public List<Map<String, String>> getQlist11() {
		return qlist11;
	}
	public void setQlist11(List<Map<String, String>> qlist11) {
		this.qlist11 = qlist11;
	}
