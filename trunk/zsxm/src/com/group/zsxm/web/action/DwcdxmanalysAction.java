...
@Scope("prototype")
@Controller
@Results( { @Result(name = "input", value = "/WEB-INF/jsp/query/dwcdxmanalys.jsp") })
public class DwcdxmanalysAction extends BaseAction{
	...
	public void doQueryListByType() {
		...
		map.put("type", type);
		List list = analysService.getListForDwcdxm(map);
