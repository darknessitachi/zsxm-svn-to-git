...
import com.netwander.explib.entity.JSONTree;
import com.netwander.explib.service.QutoService;
import com.netwander.explib.web.common.BaseAction;
import com.opensymphony.xwork2.Action;

@ParentPackage("appDefault")
@Scope("prototype")
@Results( { @Result(name = "input", value = "/WEB-INF/pages/xtgl/quto.jsp"),
		@Result(name = "menu", value = "/WEB-INF/pages/xtgl/qutoMenu.jsp") })
