...
public class XxglService  extends BaseService{
	...
	public List<Map<String,String>> getIndexListByLx(String lmid){
		String sql = "select top 6 info_zg.xxid,xxbt,convert(char(10),info_zg.rq,20) as rq from info_zg,info_lmzg where info_zg.xxid=info_lmzg.xxid and info_zg.spbz='1' and info_lmzg.lmid="+lmid+" order by info_zg.rq desc ";
		return this.getJdbcTemplate().queryForList(sql);
	}
	
	@SuppressWarnings("unchecked")
	public String getFjName(String xxid,String fjid,Integer bz){
		if(bz == 2){//人才之窗
			return getSimpleJdbcTemplate().queryForObject("select fjmc from rc_info_zgfj where xxid=? and fjxh=? ",String.class, new Object[]{xxid,fjid});
		}else{
	...
	public Page queryZgList(LimitPage limit,String _sql){
		...
		"from info_zg left join info_lmzg on info_lmzg.xxid = info_zg.xxid  where  1=1  "+temp_sql+" order by info_zg.xxid";
