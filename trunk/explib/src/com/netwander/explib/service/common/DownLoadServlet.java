...
public class DownLoadServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String bz = request.getParameter("bz")==null?"1":request.getParameter("bz");
		...
		try {
			...
			String okFileName = getFileName(xxid,fjid,Integer.parseInt(bz));
