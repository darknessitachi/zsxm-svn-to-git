...
function WdatePicker(el, dateFmt, showTime, skin, onPicked) {
	...
	if (this.top.document.dateDiv == null) {
		...
		this.dd.style.cssText = "position:absolute;z-index:9998;";
		this.dd.obj = this;
	...
	this.eCont.attachEvent("onchange", disposeDatePicker2);
	...
	if (!this.win.document.hasUnload) {
		this.win.document.attachEvent("onbeforeunload", function () {
