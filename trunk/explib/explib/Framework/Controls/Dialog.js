...
Dialog.prototype.show = function(){
	...
	if(this.isClose){
		...
		arr.push("      <div style=\"position: relative;cursor:pointer; float:right; margin:5px 0 0; _margin:4px 0 0;height:17px; width:28px; \" drag='false'></div></td>");
	}
	...
	arr.push(" id='_DialogFrame_"+this.ID+"' name='_DialogFrame_"+this.ID+"' width='100%' height='"+(parseFloat(this.Height)+36)+"' frameborder='0' style=\"background-color: #transparent; border:none;\"></iframe></td></tr>");
	arr.push("        <tr drag='false' id='_ButtonRow_"+this.ID+"'><td height='0'>");
	arr.push("            <div id='_DialogButtons_"+this.ID+"' style='display:none;text-align:right; border-top:#dadee5 1px solid; padding:8px 20px; background-color:#f6f6f6;'>");
	...
	if(!bgdiv){
		...
		bgdiv.style.cssText = "background-color:#666;position:absolute;left:0px;top:0px;opacity:0.1;filter:alpha(opacity=10);width:100%;height:" + mh + "px;z-index:960";
		$E.hide(bgdiv);
	...
	if(!this.AlertFlag){
		...
		if(!bgdiv){
			...
			bgdiv.style.cssText = "background-color:#666;position:absolute;left:0px;top:0px;opacity:0.1;filter:alpha(opacity=10);width:100%;height:" + mh + "px;z-index:991";
			$E.hide(bgdiv);
		 	pw.$T("body")[0].appendChild(bgdiv);
		}
	...
	if(bgdiv.style.display=="none"){
		...
		if(isIE&&(doc.body.currentStyle.width!='auto'&&doc.body.currentStyle.width!='100%')){
			pw.$(this.bgdivID).style.width= cw + "px";
		}
		if(this.Animator){
			$E.show(bgdiv);
			if(pw.Effect)
...
Dialog.prototype.addButton = function(id,txt,func){
	...
	if(pw.Effect){
		pw.Effect.initCtrlStyle(pw.$("_Button_"+this.ID+"_"+id));
	}
