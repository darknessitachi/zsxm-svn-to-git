...
<html>
	...
	<s:if test="parMap.xxid!=null && parMap.xxid!= ''">
	   <s:component template="xtitle" theme="app" value="信息撰稿修改"></s:component>
		   ...
		   <table width="100%" class="zgTable">
		   	<tr>
		    	...
		    	<td  class="td2">
			    	<s:iterator value="outList">
								<input type="checkBox" name="lx" value='<s:property value="LMID"/>'><s:property value="LMMC"/>
				     </s:iterator>
			 ...
			 <tr>
			      <td colspan='2' align="center">
						<input type="button" value="&nbsp;&nbsp;&nbsp;提   交&nbsp;&nbsp;&nbsp;" style="margin-right:10px;" onclick="saveXxzg();">
...
function add(id){
	document.xxzgForm.action='xxgl!xxzg.do';
...
function uploadFile(obj){
			...
			document.xxzgForm.action = "xxgl!upload.do"
...
function saveXxzg(){
	...
	var ajax = new AppAjax("xxgl!saveXxzg.do",s_b);
...
function s_b(data){
	...
	alert("信息撰写成功！");
	window.location.href = 'xxgl!xxzg.do'
	if($("xwinFlag")){
