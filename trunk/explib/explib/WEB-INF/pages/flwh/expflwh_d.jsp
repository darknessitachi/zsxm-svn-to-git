...
<html>
	...
	<body >
	    ...
	    <div id="fxtableContainer">
	    	<table cellspacing="0" class="fxtable"  style="margin-bottom:10px;">
	        	<tr>
	        		<td class="bt">专家分类名称<font color=red>*</font></td>
	...
	function doSave(){
		if($('option').value == 1){
			var ajax = new AppAjax("expflwh!addflwh.do",save_Back).submitForm("czrcForm");
		}else{
			var ajax = new AppAjax("expflwh!repflwh.do",save_Back).submitForm("czrcForm");
		}
	}
