...
<html>
	...
	<div id="fxtableContainer" class="tjtableContainer" style="width:100%;heigth:100%;overflow:auto;" >
    	<table id="tjtable" cellspacing="0" cellpadding="0">
    		<thead>
    		<tr>
    			<th class="thc" id="th1">征集专家类别</th>
    			<th class="thc" id="th2">现有专家类别</th>
    		</tr>
    		</thead>
    		<tr>
    			<td style="width:50%" id="td1">
	    			<div  class="tableContainer" id="tableContainer" style="width:100%">
						<table id="tac" style="width:100%">
							<thead>
								<tr>
	...
	<script type="text/javascript">
		...
		function doBdTb(){
			...
			diag.MessageTitle = "专家类别信息同步";
			diag.Message = "需要同步的信息请打上勾";
			diag.URL = "exptb!preBpzjT.do?rcid="+$('rcid').value+"&xh="+xh+"&xhtb="+xhtb+"&rcidtb="+$('rcidtb').value+"&opttype=1&pname="+$('pname').value+"&winid=bdtbwindows";
			diag.show();
		}
