...
<html>
	...
	<div id="fxtableContainer" class="tjtableContainer" style="width:100%;heigth:100%;overflow:auto;" >
    	<table id="tjtable" cellspacing="0" cellpadding="0">
    		<thead>
    		<tr>
    			<th class="thc" id="th1">征集主要论著论文</th>
    			<th class="thc" id="th2">现有主要论著论文</th>
    		</tr>
    		</thead>
    		<tr>
	...
	<script type="text/javascript">
		...
		function doBdTb(){
			...
			diag.URL = "exptb!preZylzT.do?rcid="+$('rcid').value+"&xh="+xh+"&xhtb="+xhtb+"&rcidtb="+$('rcidtb').value+"&opttype=1&pname="+$('pname').value+"&winid=bdtbwindows";
			diag.show();
		}
