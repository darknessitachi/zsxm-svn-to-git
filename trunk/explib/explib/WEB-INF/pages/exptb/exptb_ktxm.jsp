...
<s:hidden name="tbtname" value="EXP_KTXM"></s:hidden>
    		...
    		<tr>
    			<td style="width:50%" id="td1">
	    			<div  class="tableContainer" id="tableContainer" style="width:100%">
						<table id="tac" style="width:900px">
							<thead>
								<tr>
	...
	<script type="text/javascript">
		...
		function doBdTb(){
			...
			diag.MessageTitle = "科研项目信息同步";
			diag.Message = "需要同步的信息请打上勾";
			diag.URL = "exptb!preKtxmT.do?rcid="+$('rcid').value+"&xh="+xh+"&xhtb="+xhtb+"&rcidtb="+$('rcidtb').value+"&opttype=1&pname="+$('pname').value+"&winid=bdtbwindows";
			diag.show();
		}
