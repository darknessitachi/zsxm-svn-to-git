...
<s:hidden name="tbtname" value="EXP_JSZC"></s:hidden>
	<div id="fxtableContainer" class="tjtableContainer" style="width:100%;heigth:100%;overflow:auto;" >
    	<table id="tjtable" cellspacing="0" cellpadding="0">
    		<thead>
    		<tr>
    			<th class="thc" id="th1">征集专业领域</th>
    			<th class="thc" id="th2">现有专业领域</th>
    		</tr>
    		</thead>
    		<tr>
    			<td style="width:50%" id="td1">
	    			<div  class="tableContainer" id="tableContainer">
						<table id="tac"  style="width:450px">
							<thead>
								<tr>
							...
							<s:iterator value="qlisttb">
								<tr>
									...
									<td><input type="radio" id="xhtb<s:property value="xh"/>" name="xhtb" value='<s:property value="xh"/>'></td>
									<td>
										<s:property value="ly_mc"/>
									</td>
									<td><s:property value="zly_mc"/></td>
									<td><s:property value="sxcd"/></td>
								</tr>				
							</s:iterator>
						</table>		
					</div>
    			...
    			<td style="width:50%" id="td2">
	    			...
	    			<div  class="tableContainer" id="tableContainertb">
						<table id="tac"  style="width:450px">
							<thead>
								<tr>
									<td width="40px">比对</td>
	...
	<script type="text/javascript">
		...
		function doBdTb(){
			...
			diag.MessageTitle = "专业领域信息同步";
			diag.Message = "需要同步的信息请打上勾";
			diag.URL = "exptb!preJszcT.do?rcid="+$('rcid').value+"&xh="+xh+"&xhtb="+xhtb+"&rcidtb="+$('rcidtb').value+"&opttype=1&pname="+$('pname').value+"&winid=bdtbwindows";
			diag.show();
		}
