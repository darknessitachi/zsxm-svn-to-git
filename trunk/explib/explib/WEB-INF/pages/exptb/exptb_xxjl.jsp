...
<html>
	...
	<div id="fxtableContainer" class="tjtableContainer" style="width:100%;heigth:100%;overflow:auto;" >
    	<table id="tjtable" cellspacing="0" cellpadding="0">
    		<thead>
    		<tr>
    			<th class="thc" id="th1">征集学习简历</th>
    			<th class="thc" id="th2">现有学习简历</th>
    		</tr>
    		</thead>
    		<tr>
    			<td style="width:50%" id="td1">
	    			<div  class="tableContainer" id="tableContainer" style="width:100%">
						<table id="tac" style="width:850px">
							<thead>
								<tr>
	...
	<script type="text/javascript">
		...
		function doBdTb(){
			...
			diag.MessageTitle = "学习简历信息同步";
			diag.Message = "需要同步的信息请打上勾";
			diag.URL = "exptb!preXxjlT.do?rcid="+$('rcid').value+"&xh="+xh+"&xhtb="+xhtb+"&rcidtb="+$('rcidtb').value+"&opttype=1&pname="+$('pname').value+"&winid=bdtbwindows";
			diag.show();
		}
