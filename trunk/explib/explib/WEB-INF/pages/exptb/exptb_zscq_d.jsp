...
<html>
	...
	<s:hidden name="tbtname" value="EXP_ZSCQ"></s:hidden>
 <!--个人信息 start-->
	...
	<div class="tjtableContainer" id="fxtableContainer" style="overflow:auto;width:100%;heigth:100%">
    	<table id="tjtable" cellspacing="0" cellpadding="0" style="width:100%">
			...
			<tr>
				<td class="tdc" ><input type="checkbox" name="dmkey" value="zsmc" /></td>
				<th class="spec">知识产权名称</th>
				<td class="tdc" ><s:textfield cssStyle="width:130px" id="exptb.zsmc" name="exptb.zsmc"/></td>
				<td class="tdc" ><s:property value="exp.zsmc"/>&nbsp;</td>
			</tr>
			
			<tr>	
				<td class="tdc" ><input type="checkbox" name="dmkey" value="zsno" /></td>
				<th class="spec">知识产权类型</th>
				<td class="tdc" ><s:select name="exptb.zsno" list="xtdict17" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
				<td class="tdc" ><s:property value="exp.zsno_mc"/>&nbsp;</td>
			</tr>
			<tr>
				<td class="tdc" ><input type="checkbox" name="dmkey" value="hdrq" /></td>
				<th class="spec">获得时间</th>
				<td class="tdc" ><input type="text" class="Wdate" name="exptb.hdrq" id="zscq1_rq" style="text-align:left;width:130" value="<s:property value="exptb.hdrq"/>" onfocus="new WdatePicker(this,'%Y-%M-%D')" MINDATE="1900-01-01" readonly/></td>
				<td class="tdc" ><s:property value="exp.hdrq"/>&nbsp;</td>
			</tr>
