 ...
 <!--个人信息 start-->
	...
	<div class="tjtableContainer" id="fxtableContainer" style="overflow:auto;width:100%;heigth:100%">
    	<table id="tjtable" cellspacing="0" cellpadding="0" style="width:100%">
    		...
    		<tr>
    			<td class="tdc" ><input type="checkbox" name="dmkey" value="dwbm" /></td>
    			<th class="spec">所在单位及部门</th>
    			<td class="tdc" ><s:textfield cssStyle="text-align:left;width:130" name="exptb.dwbm" id="exptb.dwbm"/></td>
    			<td class="tdc" ><s:property value="exp.dwbm"/>&nbsp;</td>
    		</tr>
    		
    		<tr>
    			<td class="tdc" ><input type="checkbox" name="dmkey" value="zw" /></td>
    			<th class="spec">从事岗位或职务</th>
    			<td class="tdc" ><s:textfield cssStyle="text-align:left;width:130" name="exptb.zw" id="exptb.zw"/></td>
    			<td class="tdc" ><s:property value="exp.zw"/>&nbsp;</td>
    		</tr>
    	</table>	
	</div>
