...
<html>
	...
	<s:form name="emasForm" action="xtgl!updteDict.do" method="post">
	<body >
		<s:hidden name="query.dictbh" id="query.dictbh"></s:hidden>
		<s:hidden name="query.lbid" id="query.lbid"></s:hidden>
		<s:hidden name="query.fldm" id="query.fldm"></s:hidden>	
	    ...
	    <div id="xwincontent">
	    	...
	    	<div class="title">
		    	<span style='margin-left:0px;float:left'>
		    			字典名称：&nbsp;&nbsp;
		    			<input type="text" id="dictname" name="query.dictname" value="<s:property value="listMap.dictname"/>">
	          	</span>
	    	</div>
	...
	<script type="text/javascript">
		...
		function updatedict(){
			...
			var ajax = new AppAjax("xtgl!updteDictfl.do",save_Back);
