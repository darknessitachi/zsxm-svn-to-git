	...
	<script type="text/javascript">
		...
		function loadTree(){
		   $("treeBox").innerHTML='';
			...
			tree.setXMLAutoLoading("xtgl!getDict.do?query.lbid="+$("dictid").value);
			tree.loadXML("xtgl!getDict.do?query.lbid="+$("dictid").value);
		...
		function updatedict(){
		   ...
		   //var bhs = tree.getAllChecked();
			...
			diag.Width = 300;
			diag.Height = 100;
			diag.URL = "xtgl!getUpdateDict.do?query.type="+type+"&query.dictbh="+dictbh+"&query.lbid="+$("dictid").value+"&opttype=3"+"&winid=dictindexwindows";
			diag.show();	
		...
		function deletedict(){
			...
			if(confirm("确定要删除字典信息吗！"))
  			{
				var ajax = new AppAjax("xtgl!deleteDict.do",save_Back);
