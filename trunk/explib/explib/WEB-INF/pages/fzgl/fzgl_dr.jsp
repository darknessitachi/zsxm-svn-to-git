...
<html>
		...
		<s:form name="spForm" action="" method="post">
				...
				<table width="100%" cellpadding="0" cellspacing="0" id="conTable" >
						    ...
						    <td class="center" >
						    	...
						    	<input type="button" class="but" value="导入数据" id="b_sendmessage" onclick="preDr()">
						    	<input type="button" class="but" value="同   步" id="b_sendmessaged" onclick="">
	...
	var gridOption = {
		...
		remoteSort : true,
		remoteFilter : true,
		loadURL : APP_PATH + '/fzgl!getList.do?itype=2',
		exportURL : APP_PATH + '/fzgl!exportList.do?itype=2',
		exportFileName : "专家信息",
		autoLoad : true
	};
	...
	function preDr(){
		...
		diag.MessageTitle = "导入数据";
		diag.Message = "请选择相应的模板";
		diag.URL = "fzgl!predrdata.do?opttype=3"+"&winid=yrwindows";
		diag.show();
	}
