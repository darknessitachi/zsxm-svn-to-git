...
<html>
	...
	<body style="margin: 0px; overflow: hidden; margin: 2px;">
		<s:form name="spForm" action="" method="post">
				...
				<table width="100%" cellpadding="0" cellspacing="0" id="conTable" >
						    ...
						    <td class="center" >
						    	字段
						    	<select name="where" id="where" style="width:130px" onchange="changefield(this.value)">
						    	...
						    	<input type="button" class="but" value="批量同步" id="b_sendmessage" onclick="batchtb()">
						    	<input type="button" class="but" value="高级查询" id="gjcx_but" onclick="queryTj();">
							</td>
				...
				<table class="fxtable" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="bt">学历</td>
						<td  colspan=3><s:select name="xl" id="xl" list="xtdict2" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
					</tr>
					<tr>
						<td class="bt">学位</td>
						<td  colspan=3><s:select name="xw"  id="xw" list="xtdict3" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
					</tr>
					<tr>
						<td class="bt">专业技术职务</td>
						<td  colspan=3><s:select name="zc" id="zc"  list="xtdict5" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
					</tr>
					<tr>
						<td class="bt">专业技术职务等级</td>
						<td  colspan=3><s:select name="zw" id="zw"  list="xtdict23" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
					</tr>
					<tr>
						<td class="bt">单位性质</td>
						<td  colspan=3><s:select name="dwxz" id="dwxz"  list="xtdict12" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>
					</tr>
					...
					<tr>
						...
						<td  colspan=3><s:select name="zzxmlb" id="zzxmlb"  list="xtdict28" cssStyle="width:130" listKey="dictbh" listValue="dictname"  headerKey="" headerValue="--请选择--" /></td>					
					</tr>
	...
	function batchtb(){
		...
		if(window.confirm('您确定要同步 '+len+' 条数据?')){
			var r = new Array();
			for(var i=0;i<len;i++){
				r.push(mygrid.getSelectedRecords()[i].RCID);
			}
			var h = document.body.clientHeight;
			diag = new Dialog("expbatchtbwindows");
			diag.Title = '专家信息同步';
			diag.Width = 340;
			diag.Height = 100 ;
			diag.ShowMessageRow=true;
			diag.MessageTitle = "专家信息同步";
			diag.Message = "请选择同步专家所属的分类!";
			diag.URL = "exptb!preExpbatchtb.do?tbtype=WB&rcidtb="+r+"&opttype=3"+"&winid=expbatchtbwindows";
			diag.show();
		}
	}
	</script>
